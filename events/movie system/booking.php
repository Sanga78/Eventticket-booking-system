...
if(!isset($_SESSION['user']))
{
	...
	?>
	<head>
	 <link rel="icon" type="" href="assets/imgs/movie-city-1.svg">
	</head>
<div class="content">
	<div class="wrap">
							...
							<div class="col-md-12 text-center" style="padding-bottom:20px">
								...
								?>
									...
									<tr>
										...
										<td>
											<form  action="process_booking.phps" method="post">
												<input type="hidden" name="screen" value="<?php echo $screen['screen_id'];?>"/>
											<input type="number" required tile="Number of Seats" min="1" max="<?php echo $screen['seats']-$avl[0];?>" min="1" name="seats" class="form-control" value="1" style="text-align:center" id="seats"/>
