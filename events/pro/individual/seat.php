...
<head>
    ...
    <!-- External CSS -->
    <?php 
        require '../assets/styles/individual.php';
        require '../assets/styles/individual-options.php';
        $page="seat";
    ?>
</head>
<body>
                            ...
                            <table id="displaySeats" data-seats="<?php echo $booked_seats; ?>">
                                ...
                                <tr>
                                    ...
                                    <td id="seat-38" data-name="38">38</td>
									 <td id="seat-37" data-name="37">39</td>
                                    <td id="seat-38" data-name="38">40</td>
									 <td id="seat-37" data-name="37">41</td>
                                    <td id="seat-38" data-name="38">42</td>
									 <td id="seat-37" data-name="37">43</td>
                                    <td id="seat-38" data-name="38">44</td>
									 <td id="seat-37" data-name="37">45</td>
                                </tr>
                            </table>
