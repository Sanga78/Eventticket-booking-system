...
<?php
        ...
        $check_email = $conn->prepare("SELECT * FROM organizer WHERE email = ? OR phone = ?");
...
<?php
            ...
            $stmt = $conn->prepare("INSERT INTO organizer (name, email, password, phone, address, loc) VALUES (?,?,?,?,?,?)");
...
<div class="login-page">
        <center><h2> Register Organizer below</h2></center>
        <div class="form">
